...
@section('title', __('app.add_language'))
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="d-flex align-items-center mb-4">
                ...
                <h2 class="fw-bold mb-0">{{ __('app.add_language') }}</h2>
            </div>
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.languages.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label for="name" class="form-label">{{ __('app.language_name') }}</label>
                            ...
                            <div class="col-md-6">
                                <label for="code" class="form-label">{{ __('app.language_code') }}</label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <label for="flag" class="form-label">{{ __('app.flag_image') }}</label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">{{ __('app.direction') }}</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-4">
                                    ...
                                    <label class="form-check-label" for="is_default">{{ __('app.set_as_default') }}</label>
                                </div>
                            </div>
